...
public class LevelManager : MonoBehaviour
{
    ...
    public void LoadLevel(int levelNumber)
    {
        ...
        currentLevelData = LevelFactory.CreateLevel(levelNumber);
        ...
        {
            Debug.Log($"Loaded Level: {currentLevelData.levelName}, Mechanic Type: {currentLevelData.mechanicType}"); // Debug Log
            puzzleView.DisplayLevel(currentLevelData); // Display the level in the UI
        }
        else
        {
